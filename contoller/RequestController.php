...
class Router extends DataTrafficWithDatabase {
  ...
  public function searchController()
  {
      ...
      $result = mysqli_query($this->getConnection(), "SELECT * FROM users WHERE username='$username' AND password='$password' AND role='Administrator' AND not deleted;");
      ...
      try {
          ...
          if (isset($_GET['url'])) {
              ...
              $controllerFile = '../contollers/' . $controllerClass . 'php';
